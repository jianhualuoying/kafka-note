...
public abstract class AbstractRequest implements AbstractRequestResponse {
    ...
    public Send toSend(String destination, RequestHeader header) {
        // org.apache.kafka.common.requests.AbstractRequest#serialize(org.apache.kafka.common.requests.RequestHeader)方法，序列化请求，
        // 其实就是把请求头和请求体放到 Bytebuffer 中
    ...
    public ByteBuffer serialize(RequestHeader header) {
        // header.toStruct()是头信息的序列化，由于当前对象就是请求类，所以org.apache.kafka.common.requests.AbstractRequest.toStruct方法可以序列化请求体
